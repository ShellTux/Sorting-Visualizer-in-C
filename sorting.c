...
void quickSort(int arr[], int low, int high, int length) {
	copyArray(arr, originalArray, length);
...
void mergeSort(int arr[], int l, int r) {
	copyArray(arr, originalArray, NUMBER_OF_ELEMENTS);
...
/*// n is size of heap */
void heapify(int arr[], int length, int N, int i) {
	copyArray(arr, originalArray, length);
...
/*/1* function to sort arr using shellSort *1/ */
